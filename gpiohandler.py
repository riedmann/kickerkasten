...
class gpiohandler:
    ...
    def __init__(self):
       ...
       pygame.mixer.init()
       self.goalsound = pygame.mixer.Sound("/home/raspi/Coding/kicker/kickerkasten/sound/goal.ogg")
       self.notValidGoal = pygame.mixer.Sound("/home/raspi/Coding/kicker/kickerkasten/sound/nogoal.ogg")
